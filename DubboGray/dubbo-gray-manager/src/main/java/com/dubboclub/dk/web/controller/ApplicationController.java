...
public class ApplicationController {
    ...
    public  @ResponseBody  List<AppProvideInfo> getServicesByApplications(@PathVariable("application")String application) throws UnsupportedEncodingException {
        ...
        List<Provider> providers = providerService.listProviderByApplication(application);
